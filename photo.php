...
<body>
    ...
    <main>
        <div class="wrap">
            <div class="main1">
                <div class="filters">
                    <h4>Résultats des produits de la catégorie Photo</h4>
                    <form method="GET">
            ...
            <div class="main2">
                ...
                <?php if ($afficherPopupRendre) : ?>
                    <div class="popup-modale">
                        <div class="popup-modale-content">
                            ...
                            <a class="close-btn" href="photo.php">Fermer</a>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php
                $request = "SELECT * FROM produits WHERE categories_id = 3 AND disponible = 1";
                $sort_order = "";
